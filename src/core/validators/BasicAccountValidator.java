 ...
 * @author arang
 */
public class BasicAccountValidator implements AccountValidatorStrategy {
    @Override
    public Response validate(BasicAccount account, UserRepository userRepository, AccountRepository accountRepository) throws ValidationException {
     // Validar saldo
